...
var StyledInput = function (_React$Component) {
  ...
  _createClass(StyledInput, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(_input2.default, _extends({ theme: theme, ref: function ref(themed) {
          if (_this2.props.autofocus) {
            var inputRef = themed.getWrappedInstance();
            (0, _reactDom.findDOMNode)(inputRef).querySelector('input').focus();
          }
