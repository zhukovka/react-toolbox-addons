...
var InputGroup = function InputGroup(_ref) {
    ...
    var other = _objectWithoutProperties(_ref, ['children', 'className', 'shadow', 'rightIcon', 'theme']);

    var classes = (0, _classnames3.default)(theme.inputgroup, (_classnames = {}, _defineProperty(_classnames, theme.rightIcon, rightIcon), _defineProperty(_classnames, theme.shadow, shadow), _classnames), className);
