        ...
        value: function renderNextControl() {
            ...
            if (this.state.showControls) {
                var _ret = function () {
                    ...
                    var controlCls = (0, _classnames3.default)(theme.customButton, theme.right);
                    return {
                        v: _react2.default.createElement(_button2.default, { icon: _constants.BUTTON_ICON_NEXT, className: controlCls,
                            flat: true,
        ...
        value: function renderPrevControl() {
            ...
            if (this.state.showControls) {
                var _ret2 = function () {
                    ...
                    var controlCls = (0, _classnames3.default)(theme.customButton, theme.left);
                    return {
                        v: _react2.default.createElement(_button2.default, { icon: _constants.BUTTON_ICON_PREV, className: controlCls,
                            flat: true,
                            onClick: function onClick(e) {
            ...
            if (this.state.showControls) {
                var _ret3 = function () {
                    ...
                    var nextButtonProps = {
                        ...
                        onClick: function onClick(e) {
                            return _this4.next(active + 1);
                        }
                    };
                    controlsArray.push(prevButtonProps, nextButtonProps);
                    return {
                        v: controlsArray.map(function (btnProps, index) {
