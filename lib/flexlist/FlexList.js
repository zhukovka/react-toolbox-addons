    ...
    var FlexList = function (_Component) {
        ...
        _createClass(FlexList, [{
            ...
            value: function renderItems() {
                ...
                return _react2.default.Children.map(this.props.children, function (item) {
                    ...
                    if (item.type === ListItem) {
                        ...
                        clone = _react2.default.cloneElement(item, { theme: _this2.props.theme });
                    }
                    return clone;
                });
            }
            ...
            value: function render() {
                ...
                var classes = (0, _classnames3.default)([theme.flexlist, theme[align]], (_classnames = {}, _defineProperty(_classnames, theme.inverse, inverse), _defineProperty(_classnames, theme.wrap, wrap), _classnames), className);
