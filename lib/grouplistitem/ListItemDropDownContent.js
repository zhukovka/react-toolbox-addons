...
var ListItemDropDownContent = function ListItemDropDownContent(_ref) {
    var title = _ref.title,
        theme = _ref.theme,
        source = _ref.source,
        other = _objectWithoutProperties(_ref, ['title', 'theme', 'source']);
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(_dropdown2.default, _extends({ className: theme.listItemContent_dropDown, value: source[0].value, source: source }, other))
    );
};
