...
var NavDrawerPlusChildren = function (_Component) {
    ...
    _createClass(NavDrawerPlusChildren, [{
        ...
        key: 'renderTitle',
        value: function renderTitle(isFirstElement) {
        ...
        value: function renderChildren() {
            ...
            return _react2.default.Children.map(children, function (c, i) {
                ...
                var clsForTop = (0, _classnames3.default)(theme.top_element, [theme[_this2.state.next]]);
                var clsForBottom = (0, _classnames3.default)(theme.bottom_element, theme[_this2.state.prev]);
                if (!(openState === 2 && i === 1)) {
                    return _react2.default.createElement(
                        'div',
                        { key: i + topOrBottom, className: NavDrawerPlusChildren.eq(i, 0) ? clsForTop : clsForBottom },
                        _this2.renderTitle(NavDrawerPlusChildren.eq(i, 0)),
                        _react2.default.createElement(
                            'div',
                            { className: theme.columnContent },
                            c
                        )
                    );
                } else {
        ...
        value: function render() {
            ...
            var classes = (0, _classnames3.default)(className, theme.navDrawerPlus, _defineProperty({}, theme.preview, openState === NavDrawerPlusChildren.modes.PREVIEW));
            return _react2.default.createElement(
