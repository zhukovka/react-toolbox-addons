    ...
    _createClass(TableWithPagination, [{
        ...
        value: function renderDropDown() {
            ...
            return _react2.default.createElement(_dropdown2.default, {
                ...
                onChange: function onChange(val) {
                    _this2.setState({ max: val, startIndex: val });
                }
            });
        }
    }, {
        ...
        value: function render() {
            var _props2 = this.props,
                ...
                theme = _props2.theme,
                limit = _props2.limit,
                props = _objectWithoutProperties(_props2, ['className', 'theme', 'limit']);

            var cls = (0, _classnames2.default)(theme.tableWithPagination, className);
            return _react2.default.createElement(
                'div',
                { className: cls },
                _react2.default.createElement(_table2.default, _extends({}, props, { onSelect: this.handleOnSelect.bind(this), source: this.renderSource(limit || 10),
