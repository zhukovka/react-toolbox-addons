  ...
  var DraggableListItem = function (_ListItem) {
    ...
    _createClass(DraggableListItem, [{
      ...
      value: function render() {
        ...
        var other = _objectWithoutProperties(_props, ['className', 'onMouseDown', 'onTouchStart', 'to', 'onClick', 'ripple', 'theme', 'onDragStart', 'onDragEnd', 'onDragOver', 'draggable']); //eslint-disable-line no-unused-vars
