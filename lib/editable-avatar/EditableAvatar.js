        ...
        value: function renderAvatar() {
            ...
            if (editable) {
                return _react2.default.createElement(
                    _avatar2.default,
                    { image: image, theme: theme, className: className },
                    _react2.default.createElement(_font_icon2.default, { value: _constants.ICON_PHOTO_CAMERA,
                        className: theme[_constants.EDITABLE_AVATAR_PHOTO_CAMERA],
