...
var RTUpload = function (_Component) {
    _inherits(RTUpload, _Component);

    function RTUpload(props) {
        _classCallCheck(this, RTUpload);

        var _this = _possibleConstructorReturn(this, (RTUpload.__proto__ || Object.getPrototypeOf(RTUpload)).call(this, props));
    ...
    _createClass(RTUpload, [{
        ...
        value: function render() {
            ...
            var classes = (0, _classnames3.default)(theme[defaultClass], (_classnames = {}, _defineProperty(_classnames, theme[_constants.CSS_DROP_ZONE_ACTIVE], isDragActive), _defineProperty(_classnames, activeClass, activeClass && isDragActive), _classnames), className);
...
RTUpload.defaultProps = {
    defaultClass: _identifiers.DROP_ZONE
};
exports.RTUpload = RTUpload;