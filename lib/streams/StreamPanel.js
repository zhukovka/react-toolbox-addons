...
var StreamPanel = function (_Component) {
    ...
    _createClass(StreamPanel, [{
        ...
        value: function renderTopPanel() {
            ...
            var activeStream = _props.activeStream;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    streams.map(function (stream, index) {
                        return _react2.default.createElement(_StreamCard.StreamCard, _extends({ key: 'stream' + index }, stream, {
                            theme: theme }));
                    }),
...
StreamPanel.propTypes = {
     ...
     * Array streams
     */
    streams: _react.PropTypes.arrayOf(_react.PropTypes.shape({
        /**
         * String image
         */
